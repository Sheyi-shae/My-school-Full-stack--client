...
import { Container, Row,Alert,Nav,Col,Button,InputGroup,Form} from 'react-bootstrap';
...
const Forumsfd = () => {
  ...
  const fetchPosts = async (page) => {
    ...
    try {
      const response = await axios.get(`http://localhost:3001/topics/posts/fd?page=${page}`, {
        headers: {
...
const updatePosts = (newPost) => {
  ...
  return (
    ...
    <div>
     <Helmet><title>Technology Forum</title></Helmet>
      <div>
      <br/>
      ...
      <Container>
      <h5>Technology Forum</h5>
      <p>Dive into conversations about cutting-edge technologies, software development, hardware advancements, and emerging trends shaping the digital landscape.</p>
    
   <Row >
      <Col>
      <CreatePostModal show={lgShow} onHide={() => setLgShow(false)} updatePosts={updatePosts}/>{/*sending as props*/}
      </Col>
      <Col>
